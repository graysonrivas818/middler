        ...
        >
          ...
          >
            <>
              ...
              <h2 className="text-center text-[#043DD7] font-bold text-[18px] sm:text-[20px] lg:text-[26px] leading-[1.2]">
              ...
              <div className="grid grid-cols-2 sm:grid-rows-2 *:max-lg:h-24 gap-3 lg:gap-7">
                {[
                  ...
                  <div
                    key={idx}
                    className="w-full"
                    onClick={() => !isSubmitting && submitSendEstimate(item.value)}
                  >
                    <button
                      type="button"
