  ...
  return (
    ...
    >
      ...
      <div className="relative container pt-16 pb-16 sm:pt-20 sm:pb-20 lg:pt-24 lg:pb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6 px-4 lg:px-0">
          {products.map((product) => (
            <article
              key={product.url}
              className="bg-white rounded-2xl shadow-[0_10px_30px_rgba(39,95,246,0.08)] p-4 lg:p-5 flex flex-col text-center"
            >
              <a
                href={product.url}
                target="_blank"
